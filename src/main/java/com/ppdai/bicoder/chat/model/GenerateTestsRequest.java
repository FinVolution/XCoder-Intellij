...
public class GenerateTestsRequest {
    ...
    private GenerateTestsRequest(GenerateTestsRequest.Builder builder) {
        ...
        this.unitTestFramework = builder.unitTestFramework;
    ...
    public static class Builder {
        ...
        public Builder unitTestFramework(String unitTestFramework) {
        ...
        public GenerateTestsRequest build() {
            return new GenerateTestsRequest(this);
        }
    }
    ...
    public void setUnitTestFramework(String unitTestFramework) {
        this.unitTestFramework = unitTestFramework;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("GenerateTestsRequest{");
        ...
        sb.append(", unitTestFramework='").append(unitTestFramework).append('\'');
