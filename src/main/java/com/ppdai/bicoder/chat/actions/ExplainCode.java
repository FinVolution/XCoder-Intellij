...
public class ExplainCode extends AnAction {
    @Override
    public void actionPerformed(@NotNull AnActionEvent anActionEvent) {
        ...
        Message message = new Message("", MessageType.EXPLAIN.getType());
    ...
    public void update(@NotNull AnActionEvent e) {
        e.getPresentation().setText(BiCoderBundle.get("chat.action.start.inline.explain.code.action.title"));
    }
}
